...
//  alldoit
//
//  Created by LeeYongJin on 14/09/2018.
...
class PickerView: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    //returns the number of 'cloumns' to display
   ...
   /* func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
     ...
     //title for picker list name
    
     */
    
    //set pickerView Row set in image
